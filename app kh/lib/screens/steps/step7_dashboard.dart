              ...
              Center(
                child: Container(
                  ...
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(20),
                    child: Image.asset(
                      'assets/images/cambodia_id_card.png',
                      fit: BoxFit.cover,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFFE8D5B7), Color(0xFFF5EDE0)],
