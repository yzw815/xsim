...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Future<void> _sendOtpToPhone() async {
    final fullPhone = '+62 $_phoneNumber'; // Indonesia country code
