      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            // Malaysia Coat of Arms Logo (120x120)
            Image.asset(
              'assets/images/malaysia_coat_of_arms.png',
              height: 120,
              width: 120,
              fit: BoxFit.contain,
            ...
            // Gap to title (Figma: 312 - 262 = 50px)
            const SizedBox(height: 50),
            // Title: "Malaysia" in red (Figma: Arial Rounded MT Bold, 40px, #CE2E30)
            Text(
              widget.t('title1'),
              ...
              style: const TextStyle(
                ...
                color: Color(0xFFCE2E30), // Malaysia red
                height: 1.2,
              ),
            ),
